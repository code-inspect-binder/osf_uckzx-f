...
write.csv2(results, "P1analysis_oldbins_results.csv")
...
plot(results$DATE, results$CEAuthoritiesMotifs, xlim = c(6,4), xaxt='n', xlab = "Century BCE", 
...
plot(results$DATE, results$NormCEAuthoritiesMotifs, xlim = c(6,4), xaxt='n', xlab = "Century BCE", 
